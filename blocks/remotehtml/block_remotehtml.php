...
class block_remotehtml extends block_base {
    ...
    function specialization() {
        global $CFG;
        $this->title = isset($this->config->title) ? format_string($this->config->title) : format_string(get_string('newhtmlblock', 'block_remotehtml'));
        $this->pasteurl = "{$CFG->wwwroot}/blocks/remotehtml/get.php?instance={$this->instance->id}";
    }
