<?php // $Id: block_quickmail.php,v 1.2.8.1 2007/03/02 03:01:46 mark-nielsen Exp $

/**
 * Language entries for Quickmail
 *
 * @author Mark Nielsen; Translation provided by Rodrigo Filgueira
 * @version $Id: block_quickmail.php,v 1.2.8.1 2007/03/02 03:01:46 mark-nielsen Exp $
 * @package quickmail
 **/
...
$string['clearhistory'] = 'Borrar el histórico';
...
$string['emailfailerror'] = 'A los siguientes usuarios no se les envió el correo debido a...';
$string['emailhistory'] = 'Historial de Correos';
$string['emailstop'] = 'direccion de correo deshabilitada:';
$string['messageerror'] = '¡Debe escribir algún mensaje!';
