...
// the gu_mathskills qtype plugin
//
...
function xmldb_qtype_gu_mathskills_upgrade($oldversion=0) {
    ...
    // but that does not have a DB upgrade script. Therefore, gu_mathskills
    // is doing it.
    ...
    if ($result && $oldversion < 2007041300) {
        $table = new XMLDBTable('question_gu_mathskills');
    ...
    if ($result && $oldversion < 2007081700) {
        ...
        $result = $result && set_field('question_gu_mathskills', 'answernumbering', 'ABCD', 'answernumbering', 'ABC');
    }
