<?php // $Id: teacherview.php,v 1.2.2.10 2008/12/10 15:25:49 thepurpleblob Exp $
...
// only display add buttons if there are some teachers
$teachers = scheduler_getteachers($context);
$displayaddbuttons = !empty($teachers);
...
if ($slots){
    ...
    if ($displayaddbuttons) {
        ...
        print_string('needteachers', 'scheduler');
    }
