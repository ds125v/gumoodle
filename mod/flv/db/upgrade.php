...
/// For each upgrade block, the file flv/version.php
...
/// First example, some fields were added to the module on 20090900
    ...
    /// Define field course to be added to flv
        $table = new XMLDBTable('flv');
        $field = new XMLDBField('course');
        $field->setAttributes(XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, null, '0', 'id');
    /// Launch add field course
        $result = $result && add_field($table, $field);

    /// Define field intro to be added to flv
        $table = new XMLDBTable('flv');
    ...
    /// Define field introformat to be added to flv
        $table = new XMLDBTable('flv');
...
/// "01" in the last two digits of the version
    ...
    /// Define field timecreated to be added to flv
        $table = new XMLDBTable('flv');
    ...
    /// Define field timemodified to be added to flv
        $table = new XMLDBTable('flv');
    ...
    /// Define index course (not unique) to be added to flv
        $table = new XMLDBTable('flv');
