...
$string['advancedoptions'] = 'Opções Avançadas Turinitin';
...
$string['anon'] = 'Anônimo';
$string['anonenabled'] = 'Correção Anônima Permitida';
...
$string['resubmissionnotenabled'] = 'Reenvios Não Permitidos';
...
$string['turnitindiagnostic_desc'] = '<b>[Cuidado]</b><br />Ativar modo de Diagnóstico somente para rastrear os problemas com o API do Turnitin.';
...
$string['turnitinsecretkey_desc'] = '<b>[Obrigatório]</b><br />Digite a sua Chave Compartilhada Turnitin<br /><i>(Configurada pelo seu Administrados Turnitin)</i>';
...
$string['turnitintool:admin'] = 'Adminitrar Ferramenta do Turnitin';
$string['turnitintool:grade'] = 'Avaliar Trabalhos da Ferramenta Turnitin';
$string['turnitintool:submit'] = 'Enviar Trabalhos da Ferramenta Turnintin';
...
$string['turnitintoolagreement_desc'] = '<b>[Obrigatório]</b><br />Digite uma declaração de confirmação de acordo para os envios.';
...
$string['turnitinuserepository'] = 'Ativar o Depósito Institucional';
$string['turnitinuserepository_desc'] = 'Escolher se permite utilizar os Depósitos Institucionais nos Trabalhos Turnitin<br /><i>(Isso só está disponível para aqueles que têm o Depósito Institucional ativado em suas contas)</i>';
$string['turnitinuserepository_help'] = 'Utilize essa configuração para ativar a opção do Depósito Institucional na tela de configuração do trabalho.';
...
$string['erater'] = 'Ativar verificação gramatical e-rater';
...
$string['erater_dictionary_engb'] = 'Dicionário de Ingles Britânico';
