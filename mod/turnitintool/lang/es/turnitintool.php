...
$string['allowlate'] = 'Permitir entregas Atrasados';
$string['allstudents'] = 'Todos los Alumnos';
$string['allsubmissions'] = 'Bandeja de Entrada de entregas';
...
$string['maxmarks'] = 'Anotcaciones máximas';
$string['mins'] = 'Mins.';
...
$string['noenrolledstudents'] = 'Por el momento no hay alumnos inscritos en este curso.';
...
$string['resultsperpage_help'] = 'Ajusta el número de resultados a mostrar en la Bandeja de Entrada de Entregas.';
...
$string['spapercheck'] = 'Comparar con trabajos almacenados de alumnos.';
$string['stage'] = 'Etapa';
$string['standardrepository'] = 'Repositorio Estándard';
...
$string['studentstatus'] = 'Enviado{$a->modified} (Paper ID: {$a->objectid})';
...
$string['duplicatesfound'] = 'Se han encontrado duplicados de los mismos ejercicios Turntitin. Los duplicados ocurren cuando uno o más ejercicios de Moodle Directo se conectan al mismo ejercicio Turnitin por la API de Turnitin. Esto puede causar problemas, como hacer que las entregas que se hacen a uno de los duplicados se mostrarán en la bandeja de entrada de entregas de las demás. Para arreglar esto, elimine los ejercicios duplicados o reajuste el curso en el que se encuentran los duplicados. <br /><br /> Se han encontrado los siguientes duplicados:';
