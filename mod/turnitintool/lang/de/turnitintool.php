...
$string['addsubmission'] = 'Einreichung hinzufügen';
$string['advancedoptions'] = 'Erweiterte Optionen für Turnitin';
$string['allowlate'] = 'Verspätete Einreichung zulässig';
$string['allstudents'] = 'Alle Studenten';
$string['allsubmissions'] = 'Eingang für Einreichung';
$string['allsubmissionsmade'] = 'Alle zulässigen Einreichungen wurden vorgenommen.';
$string['alreadysubmitted'] = 'Die Einreichung wurde nicht angenommen, weil dieser Teil der Aufgabe schon abgegeben wurde.';
$string['anon'] = 'Anonym';
$string['anonenabled'] = '&#34;Anonymes Markieren&#34; aktiviert';
$string['anytype'] = 'Alle Einreichungstypen';
...
$string['autosubmit_help'] = 'Zur automatischen Übermittlung von Einreichungen an Turnitin während des Hochladens wählen Sie die Option &#34;Beim Hochladen sofort an Turnitin übermitteln&#34;. Alternativ können Sie Einreichungen bei Moodle ablegen und sie manuell hochladen mit der Option &#34;Review vor dem Einreichen an Turnitin hochladen&#34;.';
...
$string['bulkupload'] = 'Massenupload von Einreichungen';
$string['ced'] = 'Kursende';
...
$string['commenteditwindow_help'] = 'Mit dieser Option bestimmen Sie das Zeitfenster, innerhalb dessen Benutzer Kommentare zu Einreichungen bearbeiten können. Benutzer, die Arbeiten benoten dürfen, wie zum Beispiel Tutoren, können ihre Kommentare jeder Zeit ändern.';
...
$string['copyrightagreement'] = 'Durch Anklicken des Kontrollkästchens bestätige ich, dass diese Einreichung meine eigene Arbeit ist. Ich übernehme die Verantwortung für jede Copyright-Verletzung, die aufgrund meiner Einreichung entstehen könnte.';
...
$string['deleteconfirm'] = 'Möchten Sie diese Einreichung wirklich löschen? \n\nDieser Vorgang kann nicht rückgängig gemacht werden.';
$string['deleteerror'] = 'Fehler beim Löschen';
$string['deletesubmission'] = 'Einreichung löschen';
$string['deletingsubmission'] = 'Turnitin-Einreichung wird gelöscht.';
...
$string['downloadsubmission'] = 'Einreichung herunterladen';
...
$string['hidesubmissions'] = 'Einreichungen verbergen';
...
$string['maxfilesize_help'] = 'Diese Voreinstellung legt die maximale Dateigröße für Einreichungen zu Aufgabenteilen fest. Den maximalen Wert bestimmt der Wert in den Kursvoreinstellungen. Er ist auf eine maximale Dateigröße von 20Mb begrenzt. Dies ist die maximale Dateigröße für Dateiuploads bei Turnitin.';
...
$string['mysubmissions'] = 'Meine Einreichungen';
$string['namedparts'] = 'Benannte Teile';
$string['no'] = 'Nein';
$string['nocommenterror'] = 'Sie müssen einen Kommentar eingeben.';
$string['nocomments'] = 'Es liegen keine Kommentare zu dieser Einreichung vor.';
$string['noenrolledstudents'] = 'Derzeit sind für diesen Kurs keine Studenten eingeschrieben.';
$string['nogrademark'] = 'Nein, Moodle zum Benoten der Einreichungen benutzen.';
...
$string['nosubmissions'] = 'Es wurden keine Einreichungen vorgenommen.';
...
$string['numberofparts_help'] = 'Erlaubt bei der Erstellung mehrteiliger Aufgaben den Benutzern Einreichungen zu einzelnen Teilen vorzunehmen.';
...
$string['partdeletewarning'] = 'Der Teil der Aufgabe, den Sie löschen möchten, enthält Einreichungen. Diese gehen verloren, wenn Sie diesen Aufgabenteil löschen.\n\Möchten Sie wirklich fortfahren?';
...
$string['previewtextsubmission'] = 'Vorschau für Einreichung';
...
$string['removesubmissiondata'] = 'Daten der Turnitin-Einreichung entfernen';
...
$string['resubmission'] = 'Erneute Einreichung';
$string['resubmissiongradewarn'] = 'Erneute Einreichungen zu dieser Aufgabe sind bis zum Fälligkeitsdatum zulässig. Alle vorhandenen Markierungen gehen beim erneuten Einreichen jedoch verloren. Möchten Sie fortfahren?';
$string['resubmissionnotenabled'] = 'Erneute Einreichungen nicht aktiviert';
$string['resubmit'] = 'Erneut einreichen';
$string['resultsperpage'] = 'Ergebnisse pro Seite';
$string['resultsperpage_help'] = 'Bestimmt die im Aufgabeneingang angezeigte Anzahl an Einreichungen.';
...
$string['showonlysubmissions'] = 'Nur Studenten mit Einreichung anzeigen';
...
$string['studentdeleteconfirm'] = 'Das Löschen dieser Arbeit ermöglicht das Einreichen einer anderen an deren Stelle.\nNach dem Löschen haben Sie keinen Zugriff auf Ihre Arbeit mehr.\n\nMöchten Sie die Aufgabe wirklich löschen?';
...
$string['submissionagreementerror'] = 'Sie müssen für diese Einreichung der Vereinbarung zustimmen.';
$string['submissionconnecterror'] = 'Bei der Verbindung mit Turnitin ist ein Fehler aufgetreten. Die Einreichung ist in der Warteschlange.';
$string['submissiondelete'] = 'Löschen';
$string['submissiondeleteerror'] = 'Einreichungen konnten nicht gelöscht werden.';
$string['submissionfileerror'] = 'Sie müssen der Einreichung eine Datei anhängen.';
...
$string['submissiongeterror'] = 'Abruf der Daten der Einreichung nicht möglich.';
...
$string['submissionlist_help'] = 'Mit dieser Option zeigen Sie alle eingeschriebenen Studenten unabhängig von einer Einreichung an.';
$string['submissionnotyetuploaded'] = 'Noch nicht an Turnitin übermittelt.';
$string['submissionorig'] = 'Ähnlichkeit';
$string['submissionpart'] = 'Einreichungsteil';
$string['submissionpart_help'] = 'Wählen Sie den Teil der Turnitin-Aufgabe aus, zu dem diese Einreichung gemacht werden soll.';
...
$string['submissionstudent'] = 'Studenteneinreichung';
$string['submissiontexterror'] = 'Sie müssen den Text dieser Einreichung angeben.';
$string['submissiontitle'] = 'Titel der Einreichung';
$string['submissiontitle_help'] = 'Geben Sie den Titel der Einreichung an, die Sie machen möchten.';
$string['submissiontitleduplicate'] = 'Sie müssen einen anderen Titel für diese Einreichung angeben.';
$string['submissiontitleerror'] = 'Sie müssen einen Titel für diese Einreichung angeben.';
$string['submissiontype'] = 'Art der Einreichung';
$string['submissiontype_help'] = '<p>Zeigt die bei Turnitin zulässigen Einreichungstypen an. Die Optionen sind:</p>';
$string['submissionupdateerror'] = 'Einreichungsdaten konnten nicht aktualisiert werden.';
$string['submissionuploadsuccess'] = 'Einreichung erfolgreich bei Turnitin hochgeladen';
$string['submissionurlerror'] = 'Sie müssen bei der Übermittlung die URL dieser Internetseite angeben.';
$string['submit'] = 'Einreichung hinzufügen';
$string['submitpaper'] = 'Arbeit einreichen';
$string['submitpapersto'] = 'Studentenarbeiten ablegen';
$string['submitted'] = 'Bearbeitet';
$string['submittedmax'] = 'Sie haben die maximale Anzahl an Einreichungen erreicht.';
$string['submittoturnitin'] = 'An Turnitin übermitteln';
$string['synchallconfirm'] = 'Sie sind dabei, alle Einreichungen zu diesem Satz an Aufgabenteilen mit den in Turnitin abgelegten Einreichungen zu synchronisieren. Dabei werden alle nicht mit Moodle vorgenommenen Einreichungen berücksichtigt. Gibt es eine große Anzahl an Studenten mit einer großen Anzahl an mehrteiligen Aufgaben kann dies längere Zeit in Anspruch nehmen.\n\nMöchten Sie den Vorgang dennoch fortsetzen?';
...
$string['synchstudentsubmissions'] = 'Studenteneinreichungen bei Turnitin wiederherstellen';
$string['synchyoursubmissions'] = 'An Turnitin übermittelt? Klicken Sie zur Wiederherstellung hier.';
$string['textsubmission'] = 'Texteinreichung';
$string['texttosubmit'] = 'Einzureichender Text';
$string['texttosubmit_help'] = 'Kopieren Sie den Text Ihrer Einreichung und fügen Sie ihn in dieses Feld ein.';
$string['title'] = 'Titel';
...
$string['turnitindeleteconfirm'] = 'Arbeiten zu löschen, entfernt diese aus Ihrer Einreichungsliste und aus dem Eingang,\njedoch nicht aus der Turnitin-Datenbank.\n\nMöchten Sie diese Einreichung wirklich löschen? Dieser Vorgang kann nicht rückgängig gemacht werden.';
$string['turnitindeletionerror'] = 'Die Löschung der Turnitin-Einreichung ist fehlgeschlagen. Die lokale VLE-Kopie wurde entfernt, die Einreichung bei Turnitin konnte jedoch nicht gelöscht werden.';
...
$string['turnitinrefreshsubmissions'] = 'Einreichungen aktualisieren';
...
$string['turnitintoolowner_help'] = 'Zeigt den &#39;Besitzer&#39; oder die Person an, die den Turnitin-Kurs erstellt hat. Alle Aufgaben und Einreichungen werden dem Turnitin-Account des &#39;Besitzer&#39; hinzugefügt.';
...
$string['turnitinuseanon_desc'] = 'Wählen Sie, ob &#34;Anonymes Markieren&#34; beim Benoten der Einreichungen zulässig sein soll.<br /><i>(Dies ist nur möglich, wenn &#34;Anonymes Markieren&#34; für den Account konfiguriert ist.)</i>';
$string['turnitinusegrademark'] = 'GradeMark verwenden';
$string['turnitinusegrademark_help'] = 'Mit dieser Einstellung legen Sie fest, ob Sie Turnitin GradeMark oder Moodle zum Benoten von Einreichungen verwenden.';
$string['turnitinusegrademark_desc'] = 'Wählen Sie, ob Sie GradeMark oder Moodle zum Benoten von Einreichungen verwenden möchten.<br /><i>(Dies ist nur zulässig, wenn GradeMark für den Account konfiguriert ist.)</i>';
...
$string['tutorstatus'] = '{$a->submitted}/{$a->total} Studenteneinreichungen, {$a->graded} benotete Einreichung{$a->gplural}';
$string['type'] = 'Einreichungstyp';
$string['types'] = 'Einreichungstypen';
$string['types_help'] = '<p>Einreichungen können in drei verschiedenen Formaten vorgenommen werden.</p>';
...
$string['updatestudent'] = 'Einreichungen aktualisieren {$a->from} oder {$a->to}';
...
$string['useaverage'] = 'Benoten mittels Durchschnitt der Einreichungen';
...
$string['yes'] = 'Ja';
$string['yesgrademark'] = 'Ja, GradeMark zur Benotung der Einreichungen verwenden.';
...
$string['duplicatesfound'] = 'Es wurden Duplikate gleicher Turnitin-Aufgaben gefunden. Duplikate ergeben sich, wenn eine oder mehrere Moodle-Direkt-Aufgaben mittels der API von Turnitin mit derselben Turnitin-Aufgabe verbunden sind. Dies erzeugt Problem, insofern als Einreichungen zu einem solchen Duplikat im Eingang für Einreichungen der anderen Aufgabe angezeigt werden. Um dieses Problem zu beheben, löschen Sie entweder die duplizierten Aufgaben oder setzen Sie den Kurs mit den duplizierten Aufgaben zurück. <br /><br />Folgende Duplikate wurden gefunden:';
