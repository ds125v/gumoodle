...
$string['excludebiblio_help'] = '본 환경은 학생 보고서의 참고문헌에 나타나는 본문, 인용 저작물이나 인용 섹션들이 독창성 보고서 생성시 비교검색 대상에서 제외되도록 강사가 선택할 수 있게 해줍니다. 이 환경은 개별 독창성 보고서마다 취소할 수 있습니다.';
$string['excludepercent'] = '퍼센트';
$string['excludequoted'] = '인용 자료 제외';
$string['excludequoted_help'] = '본 환경은 강사가 본문의 인용사항이 독창성 보고서 생성시 일치 검색 대상에서 제외되도록 선택할 수 있게 해줍니다. 이 환경은 개별 독창성 보고서마다 취소할 수 있습니다.';
...
$string['institutionalchecksettings'] = '<br />기관 보관소와 비교';
...
$string['maxfilesize_help'] = '본 환경은 각 과제 부분에 대한 사용자 제출물의 최고 파일 크기를 결정짓습니다. 이의 설정 가능한 최고 값은 코스 환경의 값들의 영향을 받습니다. 더 나아가 이의 최고 허용가능한 값은 Turnitin 최고 허용 파일 크기인 20Mb입니다.';
$string['maxlength'] = '{$a->field}의 최고 길이는 {$a->length} 문자';
$string['maxmarks'] = '최고 득점';
...
$string['submitpapersto_help'] = '본 환경은 특정 보고서가 Turnitin 학생 보고서 보관소에 보관될 지를 강사가 결정할 수 있도록 해줍니다. 학생 보고서 보관소에 보고서를 제출할 때의 장점은 과제에 대해 제출된 보고서들이 귀하의 현재와 과거의 클래스의 다른 제출물들에 대해 비교검색된다는 것입니다. &#34;보관소 없음&#34; 을 선택할 경우, 제출된 학생 보고서들이 Turnitin 학생 보고서 보관소에 보관되지 않을 것입니다.';
$string['submitted'] = '수정';
...
$string['turnitinapiurl_desc'] = '<b>[필수]</b><br />Turnitin API URL을 입력하십시오<br /><i>(예: https://www.turnitin.com)<br />(예: https://submit.ac.uk)</i>';
...
$string['turnitinuserepository_help'] = '과제 셋업 스크린에 있는 기관 보관소 옵션을 활성화하려면 이 환경을 사용하십시오.<br /><i>(이는 사용자가 스스로의 계정에 대한 기관 보관소를 활성화한 경우에만 사용가능합니다)</i>';
...
$string['no'] = '아니오';
$string['yes'] = '예';
$string['migrationassignmentcreated'] = '이동 과제 생성 - Id: {$a}';
$string['migrationassignmentpartcreated'] = '이동 과제 부분 생성 - Id: {$a}';
$string['migrationassignmentcreationerror'] = '이동 과제를 생성할 수 없었습니다 - 코스 {$a}';
...
$string['migrationassignmenterror3'] = '이동 과제에 대해 이벤트를 생성할 수 없었습니다- 코스 새로운 코스 모듈을 해당 섹션에 추가할 수 없었습니다 - 코스 {$a}';
...
$string['getassignmenterror'] = 'Turnitin에서 이동 과제들을 가져올 수 없었음';
...
$string['setinstructordefaults_help'] = '본 환경은 Moodle 직접 Turnitin 과제의 모든 새로운 경우들에 사용되는 기본 환경이 될 것입니다';
...
$string['coursebrowser'] = 'Turnitin 클래스 이동';
...
$string['turnitinenablepeermark_desc'] = 'Peermark 과제의 생성을 허용할 것인지를 선택하십시오. <br/><i>(이는 계정에 Peermark 구성이 있을 경우에만 사용가능합니다)</i>';
...
$string['userprofileteachercache'] = 'Turnitin 강사 코스 캐시에 (cache)';
$string['userprofileteachercache_desc'] = '본 필드는 강사에게 강사 역할이 배정된 모든 코스들을 기록하기 위해 Turnitin plugin에서 사용하는 것입니다. 본 필드를 지울 수 있지만 기능에 영향을 줄 수 있습니다.';
...
$string['turnitindefaults'] = 'Turnitin 표절 plugin 기본 활동 환경';
$string['turnitinpluginsettings'] = 'Turnitin 표절 plugin 활동 환경';
...
$string['turnitintooltwonotexist'] = 'Turnitintooltwo 가 설치되지 않았습니다. 본 plugin은 Turnitin 제 2과제 활동 모듈에 설치되어야 사용가능합니다.';
