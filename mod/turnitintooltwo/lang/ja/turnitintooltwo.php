...
$string['turnitinula'] = '提出をする前に最新のTurnitinユーザー規約に同意する必要があります。こちらをクリックし、規約に同意してください。';
...
$string['viewdigitalreceipt'] = 'デジタルレシートを閲覧する';
...
$string['turnitintooltwonotexist'] = 'Turnitintooltwo がインストールされていません。このプラグインをご利用になるには、まず Turnitin Assignment 2 アクティビティーモジュールをインストールする必要があります。';
