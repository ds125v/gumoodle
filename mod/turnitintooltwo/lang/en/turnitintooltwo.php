...
$string['setinstructordefaults_help'] = 'These settings will be the default settings used for any new instances of the Moodle Direct Turnitin Assignment';
...
$string['psuedolastnamegen_desc'] = 'If set to yes and the psuedo lastname is set to a user profile field, then the field will be automatically populated with a unique identifier.';
...
$string['turnitindefaults'] = 'Turnitin plagiarism plugin default activity settings';
$string['turnitinpluginsettings'] = 'Turnitin plagiarism plugin activity settings';
...
$string['turnitintooltwonotexist'] = 'Turnitintooltwo is not installed, this plugin requires the Turnitin Assignment 2 activity module to be installed before it can be used.';
