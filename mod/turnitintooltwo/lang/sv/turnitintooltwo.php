...
$string['maxfilesize_help'] = 'Den här inställningen avgör maximal filstorlek för användarinlämningar till varje uppgiftsdel. Det högsta värde som du kan ställa in bestäms av det värde som satts i kursinställningar. Detta värde är dessutom begränsat till en maximal filstorlek på 20 MB, vilket är den högsta tillåtna filstorleken för filuppladdningar till Turnitin.';
...
$string['setinstructordefaults_help'] = 'Dessa inställningar kommer att bli de standardinställningar som används för alla nya instanser av en Moodle Direkt Turnitin Uppgift';
...
$string['userprofileteachercache'] = 'Turnitin lärarkurs cache';
$string['userprofileteachercache_desc'] = 'Detta fält används av Turnitins plugin för att föra ett register över alla de kurser som en lärare har tilldelats att undervisa i. Du kan ta bort detta fält, men detta kan påverka prestandan.';
...
$string['turnitindefaults'] = 'Turnitin plagiering plugin: Aktivitet Standardinställningar';
$string['turnitinpluginsettings'] = 'Turnitin plagiering plugin: Aktivitetsinställningar';
...
$string['turnitintooltwonotexist'] = 'Turnitintooltwo har inte installerats. Denna plugin kräver att aktivitetsmodulen för Turnitin Uppgift 2 installeras innan den kan användas.';
