...
$string['excludebiblio_help'] = 'Esta opción le permite al profesor evitar que se busquen coincidencias al generar Reportes de originalidad en ciertas partes del trabajo, como texto que aparezca en la bibliografía, obras citadas o secciones de referencia de los trabajos de los estudiantes. Esta opción puede ignorarse en Reportes de originalidad individuales.';
$string['excludepercent'] = 'Porcentaje';
$string['excludequoted'] = 'Omitir Material Citado';
$string['excludequoted_help'] = 'Esta opción le permite al profesor evitar que se busquen coincidencias al generar Reportes de originalidad en texto que pertenezca a citas. Esta opción puede ignorarse en Reportes de originalidad individuales.';
$string['excludevalue'] = 'Omitir Equivalencias Menores';
$string['excludevalue_help'] = 'Esta opción le permite al profesor evitar que las coincidencias que no tengan la longitud suficiente (determinada por el profesor) sean consideradas al generar Reportes de originalidad. Esta opción puede ignorarse en Reportes de originalidad individuales.';
...
$string['genduedate'] = 'Generar reportes en la fecha de entrega (se permitirán segundasentregas hasta la fecha de entrega)';
$string['genimmediately1'] = 'Generar reportes inmediatamente (no se permiten segundas entregas)';
$string['genimmediately2'] = 'Generar reportes inmediatamente (se permitirán segundasentregas hasta la fecha de entrega)';
...
$string['maxfilesize_help'] = 'Esta opción determina el tamaño máximo del archivo que el usuario puede entregar a cada parte del ejercicio. El valor máximo que puedes darle a esta opción depende del valor en la configuración del curso; y está limitado a un tamaño máximo de 20Mb, que es el máximo tamaño para archivos que quieran subirse a Turnitin.';
$string['maxlength'] = 'La longitud máxima para {$a->field} son {$a->length} caracteres';
$string['maxmarks'] = 'Correcciones máximas';
...
$string['reportgenspeed_help'] = 'Hay tres opciones para la configuración de este ejercicio:&#34;'.$string['genimmediately1'].'&#34;, &#34;'.$string['genimmediately2'].'&#34; y&#34;'.$string['genduedate'].'&#34;.<br /><br />La opción &#34;'.$string['genimmediately1'].'&#34; genera el Reporte de originalidad inmediatamente cuando un estudiantes realiza una entrega. Con esta opción seleccionada, tus estudiantes no podrán volver a hacer otra entrega al ejercicio. <br /><br />Para permitir segundas entregas, selecciona la opción &#34;'.$string['genimmediately2'].'&#34;. Ésta permitirá a los estudiantes realizar segundas entregas contínuamente al ejercicio hasta la fecha de entrega. Los Reportes de originalidad pueden tardar hasta 24 horas en procesarse en el caso de segundas entregas. <br /><br />';
...
$string['spapercheck_help'] = 'Compara con el depósito de trabajos de estudiantes de Turnitin cuando estés procesando Reportes de originalidad para los trabajos. El porcentaje del índice de similitud puede disminuir si esta opción no está seleccionada.';
...
$string['turnitinapiurl_desc'] = '<b>[Requerido]</b><br />Introduce el URL del API de Turnitin <br /><i>(e.g. https://www.turnitin.com)<br />(e.g. https://submit.ac.uk)</i>';
...
$string['setinstructordefaults_help'] = 'Estas configuraciones serán las configuraciones por defecto que se utilizarán para cualquier nuevo ejemplo de ejercicio de Turnitin de Moodle Direct';
...
$string['studentdataprivacy_desc'] = 'Las siguientes opciones pueden configurarse para asegurarse que la información personal de estudiante&#39;s no se transmite a Turnitin a través del API.';
...
$string['turnitinoroptions'] = 'Opciones de Reportes originales';
...
$string['turnitindefaults'] = 'Ajustes de actividad por defecto del plugin de plagio de Turnitin';
$string['turnitinpluginsettings'] = 'Ajustes de actividad del plugin de plagio de Turnitin';
