...
$string['maxfilesize_help'] = '此設定決定用戶提交至每個作業部分的物件之最高文檔大小。您可以設置的最高值數值被課程設定內所設的數值支配，而此數值被限制為 20Mb，也就是上傳至 Turnitin 的物件的最高值。';
...
$string['turnitinapiurl_desc'] = '<b>[要求]</b><br />輸入 Turnitin API URL<br /><i>(例如： https://www.turnitin.com)<br />(例如： https://submit.ac.uk)';
...
$string['turnitinula'] = '在提交物件之前，您必須接受最新的 Turnitin 用戶同意書。請點選這裡以檢視並接受該同意書。';
...
$string['setinstructordefaults_help'] = '這些設定將會是 Moodle Direct Turnitin 作業的新的實例所使用的預設設定';
...
$string['digitalreceipt'] = '電子回條ʺʺ';
$string['viewdigitalreceipt'] = '檢視電子回條ʺʺ';
...
$string['userprofileteachercache'] = 'Turnitin 教師課程貯藏所';
$string['userprofileteachercache_desc'] = 'Turnitin plugin 用此欄來保留教師被指名為教師的所有課程的記錄 - 您可以清除此欄但這可能影響到功能。';
...
$string['turnitindefaults'] = 'Turnitin 剽竊 plugin 預設活動設置';
$string['turnitinpluginsettings'] = 'Turnitin 剽竊 plugin 活動設置';
...
$string['turnitintooltwonotexist'] = 'Turnitintooltwo 尚未安裝, 此 plugin 需要先安裝 Turnitin 作業 2 活動單元才能使用。';
$string['pp_configuredesc'] = '您必須在turnitintooltwo單元內安裝此單元。請點選 <a href=../../admin/settings.php?section=modsettingturnitintooltwo&#34;>here</a> 以安裝此 plugin&#34;';
