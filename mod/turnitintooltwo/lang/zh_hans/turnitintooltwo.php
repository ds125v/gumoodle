...
$string['turnitinapiurl_desc'] = '<b>[要求]</b><br />输入 Turnitin API URL<br /><i>(例如： https://www.turnitin.com)<br />(例如： https://submit.ac.uk)';
...
$string['setinstructordefaults_help'] = '这些设定将会是 Moodle Direct Turnitin 作业的新的实例所使用的预设设定';
...
$string['digitalreceipt'] = '电子回条ʺʺ';
$string['viewdigitalreceipt'] = '检视电子回条ʺʺ';
...
$string['userprofileteachercache'] = 'Turnitin 教师课程贮藏所';
$string['userprofileteachercache_desc'] = 'Turnitin plugin 用此栏来保留教师被指名为教师的所有课程的记录 - 您可以清除此栏但这可能影响到功能。';
...
$string['turnitindefaults'] = 'Turnitin 剽窃 plugin 预设活动设置';
$string['turnitinpluginsettings'] = 'Turnitin 剽窃 plugin 活动设置';
...
$string['turnitintooltwonotexist'] = 'Turnitintooltwo 尚未安装, 此 plugin 需要先安装 Turnitin 作业 2 活动单元才能使用。';
$string['pp_configuredesc'] = '您必须在turnitintooltwo单元内安装此单元。请点选 <a href=../../admin/settings.php?section=modsettingturnitintooltwo&#34;>here</a> 以安装此 plugin&#34;';
